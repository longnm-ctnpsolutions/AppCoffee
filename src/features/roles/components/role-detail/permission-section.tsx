                                            ...
                                            <TableRow key={headerGroup.id} className="border-0 hover:bg-transparent">
                                                {headerGroup.headers.map((header) => (
                                                    <TableHead
                                                        ...
                                                        style={{
                                                            width: header.id === 'name' ? '30%' : header.id === 'description' ? '40%' : header.id === 'clientName' ? '20%' : 'auto'
                                                        }}
                                                    >
                                                ...
                                                >
                                                    {row.getVisibleCells().map((cell) => (
                                                        <TableCell
                                                            ...
                                                            style={{
                                                                width: cell.column.id === 'name' ? '30%' : cell.column.id === 'description' ? '40%' : cell.column.id === 'clientName' ? '20%' : 'auto'
                                                            }}
                                                        >
