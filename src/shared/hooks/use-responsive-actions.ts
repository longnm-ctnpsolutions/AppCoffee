...
export interface ActionItem {
  ...
  hideAt?: {
    minWidth: number
    condition?: (params: { windowWidth: number; isSidebarExpanded: boolean }) => boolean
  }
  children?: ActionItem[]
  component?: React.ReactNode  // For standalone usage
  dropdownComponent?: React.ReactNode  // For dropdown usage
  
  // NEW: Thêm để hỗ trợ Column Chooser
  table?: any  // Table instance từ @tanstack/react-table
  dialog?: {
    title?: string
    description?: string
    actionLabel?: string
